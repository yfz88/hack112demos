class Graph:
    ...
    # Edges --> [List]: each element is a tuple signifying edge between nodes 
    # numberOfNodes --> int: Number of nodes in the graph
    def graphNew(self, edges, numberOfNodes): 
        # Initialize set of all nodes in a graph
