...
This code is from the Pygame Github repository.
...
* Importing GIFs + Useful sprite features

Note: You can make a very similar game just using CMU Graphics so please only
use Pygame if you need the additional features and have enough time to
learn how to use it.
